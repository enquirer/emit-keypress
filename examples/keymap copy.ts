export const keymap = [
  ...
  { shortcut: 'shift+left', command: 'select_char_left', sequence: '\x1b[1;5D', weight: 0 },

  { shortcut: 'shift+right', command: 'select_right', sequence: '\x1b[1;2C', weight: 0 },
  { shortcut: 'shift+right', command: 'select_char_right', sequence: '\x1b[1;5C', weight: 0 },
  ...
  { shortcut: 'meta+down', command: 'expand_down', sequence: '\x1b[1;3B', weight: 0 },
