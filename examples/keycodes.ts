export const keycodes = [
  ...
  { shortcut: 'fn+ctrl+right', command: 'select_word_right', sequence: '\x1B[1;5C', weight: -1 },
  { shortcut: 'ctrl+left', command: 'home', sequence: '\x1B[1;5D', weight: 0 },
  { shortcut: 'fn+ctrl+left', command: 'select_word_left', sequence: '\x1B[1;5D', weight: -1 },
  ...
  { shortcut: 'fn+meta+left', command: 'select_word_left', sequence: '\x1B[1;3D', weight: -1, notes: 'Double check, this is probably wrong' },
  { shortcut: 'fn+meta+right', command: 'select_word_right', sequence: '\x1B[1;3C', weight: -1, notes: 'Double check, this is probably wrong' },
  ...
  { shortcut: 'meta+left', command: 'move_word_left', sequence: '\x1B\x1B[D', weight: 0 },
